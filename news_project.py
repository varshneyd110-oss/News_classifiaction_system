...
import sqlite3
from database import update_login_count,get_user_login_data,get_total_users,create_feedback_table,get_all_feedbacks,save_feedback
...
if st.session_state.get("logged_in", False):
    ...
    st.write("📰 Prediction System Here")

else:
    st.warning("⚠ Please Login First")    

# ====================================
# FEEDBACK + LOGOUT DIALOG
# ====================================

@st.dialog("💬 Before Logout")
def feedback_logout_dialog():

    st.write(
        "Please share your feedback before logout ❤️"
    )
    ...
    if st.button("🚀 Submit & Logout",use_container_width=True):
